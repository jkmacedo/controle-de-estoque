...
class BaseWindows(ctk.CTk):
    ...
    def __init__(self, titulo='nome da janela', largura=400, altura=500):
        ...
        self.configure(fg_color=self.cores["amarelo2"]) # define a cor de fundo da janela
    ...
    def criar_entry(self, master, placeholder=None, largura=300, espessura=40, senha=False):
    ...
    # cria um botão
    def criar_botao(self, master, texto, comando, cor_texto=False, largura=140, espessura=35, fg_cor=False, hover_cor=False, tamanho_letra=14):
        ...
        return ctk.CTkButton(
            ...
            text_color= cor_texto if cor_texto else self.cores["branco"],
            width=largura,
            height=espessura,
    ...
    def criar_menu(self, master, valores=None, variavel=None):
        ...
        button_color=self.cores["marrom_escuro"],
