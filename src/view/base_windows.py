...
class BaseWindows(ctk.CTk):
    ...
    def criar_label(self, master, texto, front='normal', tamanho_letra=16, negrito=False, cor_texto="marrom", mao=False):
    ...
    # cria um botão
    def criar_botao(self, master, texto, comando, largura=140, espessura=35, fg_cor="marrom", hover_cor="marrom_escuro", tamanho_letra=14):
